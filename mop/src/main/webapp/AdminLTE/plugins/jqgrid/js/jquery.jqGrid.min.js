...
!function(a) {
	...
	$.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
		...
		return this.each(function() {
			...
			if (!this.grid) {
				...
				var e = this,
					f = {
						...
						scrollGrid : function(a) {
							...
							f.hDiv.scrollLeft = f.bDiv.scrollLeft, d.footerrow && (f.sDiv.scrollLeft = f.bDiv.scrollLeft), d.frozenColumns && $(f.fbDiv).scrollTop(f.bDiv.scrollTop);try {
								$("#column_menu").remove()
							} catch (a) {} a && a.stopPropagation()
						},
				...
				var z,
						...
						if (g && (e.p.data = [], e.p._index = {}, e.p.localReader.id = h), e.p.reccount = 0, $.isXMLDoc(a)) {
							...
							if (e.p.grouping && (W = !0 === e.p.groupingView.groupCollapse, O = $.jgrid.getMethod("groupingPrepare")), Q > 0 && e.p.page <= 0 && (e.p.page = 1), M && Q) {
								...
								for (var X = $.isFunction(e.p.afterInsertRow), Y = A ? m(n, "rownumBox", !1, "jqgrid-rownum") : "", _ = y ? m(n, "multiBox", !1, "cbox") : ""; R < Q;) {
									u = M[R], v = s(u, U + R), v = e.p.idPrefix + v, e.p.preserveSelection && (e.p.multiselect ? (P = -1 !== e.p.selarrrow.indexOf(v), j = P ? j + 1 : j) : P = v === e.p.selrow);var aa = E.length;
					...
					R = function(a, b, c, d) {
						...
						if (a) {
							...
							for (A && (e.p.data = [], e.p._index = {}, e.p.localReader.id = z), e.p.reccount = 0, e.p.page = B($.jgrid.getAccessor(a, g.page), e.p.page), e.p.lastpage = B($.jgrid.getAccessor(a, g.total), 1), e.p.records = B($.jgrid.getAccessor(a, g.records)), e.p.userData = $.jgrid.getAccessor(a, g.userdata) || {}, M && (q = $.jgrid.getMethod("addSubGridCell")), v = !1 === e.p.keyName ? $.isFunction(g.id) ? g.id.call(e, a) : g.id : e.p.keyName, g.repeatitems && e.p.keyName && isNaN(v) && (v = e.p.keyIndex), u = $.jgrid.getAccessor(a, g.root), null == u && $.isArray(a) && (u = a), u || (u = []), t = u.length, k = 0, t > 0 && e.p.page <= 0 && (e.p.page = 1), d && (Q *= d + 1), "local" !== e.p.datatype || e.p.deselectAfterSort || (R = !0), e.p.grouping && (_ = !0 === e.p.groupingView.groupCollapse, y = $.jgrid.getMethod("groupingPrepare")); k < t;) {
								...
								x = e.p.idPrefix + x, (R || e.p.preserveSelection) && (e.p.multiselect ? (r = -1 !== e.p.selarrrow.indexOf(x), j = r ? j + 1 : j) : r = x === e.p.selrow);var ea = V.length;
					...
					T = function(a, b) {
						...
						if (l = e.p.pager || "", l += e.p.toppager ? l ? "," + e.p.toppager : e.p.toppager : "") {
							if (j = $.jgrid.getRegional(e, "formatter.integer"), c = B(e.p.page), d = B(e.p.lastpage), $(".selbox", l)[this.p.useProp ? "prop" : "attr"]("disabled", !1), !0 === e.p.pginput && ($("#input" + r).html($.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input " + m(n, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(p) + "'></span>")), e.p.toppager && $("#input_t" + s).html($.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input " + m(n, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(p) + "_toppager'></span>")), $(".ui-pg-input", l).val(e.p.page), k = e.p.toppager ? "#sp_1" + r + ",#sp_1" + r + "_toppager" : "#sp_1" + r, $(k).html($.fmatter ? $.fmatter.util.NumberFormat(e.p.lastpage, j) : e.p.lastpage)), e.p.viewrecords)
								if (0 === e.p.reccount) $(".ui-paging-info", l).html($.jgrid.getRegional(e, "defaults.emptyrecords", e.p.emptyrecords));else {
					...
					Y = function(a) {
						if (!e.grid.hDiv.loading) {
							...
							case "script":
								...
								break;case "local":
							case "clientside":
								U(), e.p.datatype = "local", e.p._ald = !0;var r = S(!1);
					...
					_ = function(a, b) {
						var c,
							...
							j,
							k,
							l = "<td class='ui-pg-button " + o + "'><span class='ui-separator'></span></td>",
							p = "",
					...
					la = function(a, b, c) {
						...
						var g,
							h,
							i = '<ul id="column_menu" role="menu" tabindex="0">',
							j = "",
							k = "</ul>",
							l = "",
							m = e.p.colModel[a],
				...
				var ma,
					...
					ta,
					ua,
					va = "<thead><tr class='ui-jqgrid-labels' role='row'>",
					wa = "",
					xa = "",
					ya = "";
				if (!0 === e.p.shrinkToFit && !0 === e.p.forceFit)
					for (k = e.p.colModel.length - 1; k >= 0; k--)
						if (!e.p.colModel[k].hidden) {
							e.p.colModel[k].resizable = !1;break
				}
				...
				if (e.p.disableClick = !1, $("th", Fa).each(function(a) {
					...
					} catch (a) {} e.p.footerrow && (Da += "</tr></tbody></table>"), Ga += "</tr>", sa = document.createElement("tbody"), this.appendChild(sa), $(this).addClass(m(n, "rowTable", !0, "ui-jqgrid-btable ui-common-table")).append(Ga), e.p.altRows && $(this).addClass(m(n, "stripedTable", !0, "")), Ga = null;
				...
				$(e).before(f.hDiv).on({
					...
					reloadGrid : function(a, b) {
						...
						return e.grid.prevRowHeight && e.p.scroll && void 0 === b.page ? (
								delete e.p.lastpage
			...
			return this.each(function() {
				...
				if (c.grid && !0 === c.p.cellEdit) {
					if (null !== d) {
						var g,
							h,
							i = $(c).jqGrid("getGridRowById", c.p.savedRow[0].rowId),
							j = $("td:eq(" + b + ")", i),
							k = c.p.colModel[b],
							l = k.name,
							m = $.jgrid.jqID(l),
							...
							if (!0 === t[0]) {
								...
								if ($("input.hasDatepicker", j).length > 0 && $("input.hasDatepicker", j).datepicker("hide"), "remote" === c.p.cellsubmit)
									if (c.p.cellurl) {
										...
										} catch (a) {}"clientArray" === c.p.cellsubmit && ($(j).empty(), $(c).jqGrid("setCell", c.p.savedRow[d].rowId, b, h, !1, !1, !0), $(j).addClass("dirty-cell"), $(i).addClass("edited"), $(c).triggerHandler("jqGridAfterSaveCell", [ c.p.savedRow[d].rowId, l, g, a, b ]), $.isFunction(c.p.afterSaveCell) && c.p.afterSaveCell.call(c, c.p.savedRow[d].rowId, l, g, a, b), c.p.savedRow.splice(0, 1))
							} else try {
				...
				if (c.grid && !0 === c.p.cellEdit) {
					if (null !== d) {
						...
						if ($.isFunction($.fn.datepicker)) try {
							...
							} catch (a) {} $(f).empty().attr("tabindex", "-1"), $(c).jqGrid("setCell", c.p.savedRow[0].rowId, b, c.p.savedRow[d].v, !1, !1, !0), $(c).triggerHandler("jqGridAfterRestoreCell", [ c.p.savedRow[d].rowId, c.p.savedRow[d].v, a, b ]), $.isFunction(c.p.afterRestoreCell) && c.p.afterRestoreCell.call(c, c.p.savedRow[d].rowId, c.p.savedRow[d].v, a, b), c.p.savedRow.splice(0, 1)
					}
					window.setTimeout(function() {
		...
		hideModal : function(a, b) {
			...
			if ($.fn.jqm && !0 === b.jqm) $(a).attr("aria-hidden", "true").jqmHide();else {
				...
				} catch (a) {} $(a).hide().attr("aria-hidden", "true")
			}
		...
		createModal : function(a, b, c, d, e, f, g) {
			...
			if (c.resize)
				if ($.fn.jqResize) $(l).append("<div class='jqResize " + j.resizable + " " + k.icon_base + " " + j.icon_resizable + "'></div>"), $("#" + $.jgrid.jqID(a.themodal)).jqResize(".jqResize", !!a.scrollelm && "#" + $.jgrid.jqID(a.scrollelm));else try {
						$(l).resizable({
							handles : "se, sw",
		...
		viewModal : function(a, b) {
			...
			if (void 0 === b.focusField && (b.focusField = 0), "number" == typeof b.focusField && b.focusField >= 0 ? b.focusField = parseInt(b.focusField, 10) : "boolean" != typeof b.focusField || b.focusField ? b.focusField = 0 : b.focusField = !1, $.fn.jqm && !0 === b.jqm)
				b.jqM ? $(a).attr("aria-hidden", "false").jqm(b).jqmShow() : $(a).attr("aria-hidden", "false").jqmShow();else {
				if ("" !== b.gbox) {
		...
		createEl : function(a, b, c, d, e) {
			...
			case "textarea":
				...
				if (!0 === b.multiple ? (k = !0, g.multiple = "multiple", $(g).attr("aria-multiselectable", "true")) : k = !1, null != b.dataUrl) {
					...
					try {
						m = b.rowId
					} catch (a) {} h.p && h.p.idPrefix && (m = $.jgrid.stripPref(h.p.idPrefix, m)), $.ajax($.extend({
					...
					var p,
						...
						t,
						u,
						v = void 0 === b.separator ? ":" : b.separator,
			...
			if (!this.filter) {
				...
				if (this.p.initFilter = $.extend(!0, {}, this.p.filter), c) {
					...
					this.onchange = function() {
						...
						var v,
							w = e.p.ruleButtons && e.p.uniqueSearchFields;
						if (w)
						...
						o.append(q);
						var r,
							s = $("<select size='1' class='" + h.srSelect + "'></select>"),
							t = [];
						...
						for (b = 0; b < this.p.ops.length; b++)
							if (this.p.ops[b].oper === a.op) {
								f = this.p.operands.hasOwnProperty(a.op) ? this.p.operands[a.op] : "", g = this.p.ops[b].oper;break
						}
						...
						if (a.styleUI = c.p.styleUI, "string" == typeof i && (i = $.jgrid.parse(i)), !0 === a.recreateFilter && $("#" + $.jgrid.jqID(h.themodal)).remove(), void 0 !== $("#" + $.jgrid.jqID(h.themodal))[0]) b($("#fbox_" + $.jgrid.jqID(c.p.id)));else {
							...
							a.layer ? $.jgrid.createModal(h, l, a, "#gview_" + $.jgrid.jqID(c.p.id), $("#gbox_" + $.jgrid.jqID(c.p.id))[0], "string" == typeof a.layer ? "#" + $.jgrid.jqID(a.layer) : a.layer, "string" == typeof a.layer ? {
								...
								if (a.stringResult) {
									try {
										b = JSON.stringify(f)
									} catch (a) {} "string" == typeof b && (i[a.sFilter] = b, $.each([ a.sField, a.sValue, a.sOper ], function() {
										i[this] = ""
									}))
								} else
				...
				return b = $.extend(!0, {
							...
							if ("_empty" !== a && (p = $(b).jqGrid("getInd", a)), $(b.p.colModel).each(function(l) {
									if (f = this.name, g = (!this.editrules || !0 !== this.editrules.edithidden) && !0 === this.hidden, j = g ? "style='display:none'" : "", "cb" !== f && "subgrid" !== f && !0 === this.editable && "rn" !== f) {
										if (!1 === p)
											...
											i = $("td[role='gridcell']:eq(" + l + ")", b.rows[p]).text();else {
											try {
						...
						function g(a, b, c) {
							var d,
								...
								i,
								j = 0;
							(rp_ge[q.p.id].checkOnSubmit || rp_ge[q.p.id].checkOnUpdate) && (q.p.savedData = {}, q.p.savedData[b.p.id + "_id"] = a);var k = b.p.colModel;
						...
						function i() {
							...
							if (h(), l[0] && (m = $(q).triggerHandler("jqGridAddEditClickSubmit", [ rp_ge[q.p.id], s, u ]), void 0 === m && $.isFunction(rp_ge[q.p.id].onclickSubmit) && (m = rp_ge[q.p.id].onclickSubmit.call(q, rp_ge[q.p.id], s, u) || {}), l = $(q).triggerHandler("jqGridAddEditBeforeSubmit", [ s, $(w), u ]), void 0 === l && (l = [ !0, "", "" ]), l[0] && $.isFunction(rp_ge[q.p.id].beforeSubmit) && (l = rp_ge[q.p.id].beforeSubmit.call(q, s, $(w), u))), l[0] && !rp_ge[q.p.id].processing) {
								if (rp_ge[q.p.id].processing = !0, $("#sData", y + "_2").addClass(f.active), k = rp_ge[q.p.id].url || $(q).jqGrid("getGridParam", "editurl"), d = n.oper, c = "clientArray" === k ? q.p.keyName : n.id, s[d] = "_empty" === $.trim(s[q.p.id + "_id"]) ? n.addoper : n.editoper, s[d] !== n.addoper ? s[c] = s[q.p.id + "_id"] : void 0 === s[c] && (s[c] = s[q.p.id + "_id"]),
									delete s[q.p.id + "_id"]
									, s = $.extend(s, rp_ge[q.p.id].editData, m), !0 === q.p.treeGrid) {
									if (s[d] === n.addoper) {
								...
								var t = $.extend({
									...
									complete : function(e, h) {
										...
										if ($("#sData", y + "_2").removeClass(f.active), s[c] = q.p.idPrefix + s[c], e.status >= 300 && 304 !== e.status ? (l[0] = !1, l[1] = $(q).triggerHandler("jqGridAddEditErrorTextFormat", [ e, u ]), $.isFunction(rp_ge[q.p.id].errorTextFormat) ? l[1] = rp_ge[q.p.id].errorTextFormat.call(q, e, u) : l[1] = h + " Status: '" + e.statusText + "'. Error code: " + e.status) : (l = $(q).triggerHandler("jqGridAddEditAfterSubmit", [ e, s, u ]), void 0 === l && (l = [ !0, "", "" ]), l[0] && $.isFunction(rp_ge[q.p.id].afterSubmit) && (l = rp_ge[q.p.id].afterSubmit.call(q, e, s, u))), !1 === l[0]) $(".FormError", w).html(l[1]), $(".FormError", w).show();
												...
												$(q).triggerHandler("jqGridAddEditAfterComplete", [ a, s, $(w), u ]);try {
										...
										if (k = {}, k = $(c).triggerHandler("jqGridDelRowClickSubmit", [ rp_ge[c.p.id], l ]), void 0 === k && $.isFunction(rp_ge[c.p.id].onclickSubmit) && (k = rp_ge[c.p.id].onclickSubmit.call(c, rp_ge[c.p.id], l) || {}), e = $(c).triggerHandler("jqGridDelRowBeforeSubmit", [ l ]), void 0 === e && (e = [ !0, "", "" ]), e[0] && $.isFunction(rp_ge[c.p.id].beforeSubmit) && (e = rp_ge[c.p.id].beforeSubmit.call(c, l)), e[0] && !rp_ge[c.p.id].processing) {
												...
												complete : function(a, g) {
													...
													if ($("#dData", "#" + m + "_2").removeClass(f.active), a.status >= 300 && 304 !== a.status ? (e[0] = !1, e[1] = $(c).triggerHandler("jqGridDelRowErrorTextFormat", [ a ]), $.isFunction(rp_ge[c.p.id].errorTextFormat) && (e[1] = rp_ge[c.p.id].errorTextFormat.call(c, a)), void 0 === e[1] && (e[1] = g + " Status: '" + a.statusText + "'. Error code: " + a.status)) : (e = $(c).triggerHandler("jqGridDelRowAfterSubmit", [ a, d ]), void 0 === e && (e = [ !0, "", "" ]), e[0] && $.isFunction(rp_ge[c.p.id].afterSubmit) && (e = rp_ge[c.p.id].afterSubmit.call(c, a, d))), !1 === e[0]) $("#DelError>td", "#" + m).html(e[1]), $("#DelError", "#" + m).show();else {
														...
														if ($.isFunction(rp_ge[c.p.id].afterComplete) || $._data($(c)[0], "events").hasOwnProperty("jqGridDelRowAfterComplete")) {
															var i = a;
															setTimeout(function() {
																$(c).triggerHandler("jqGridDelRowAfterComplete", [ i, d ]);try {
											...
											if (n.url || rp_ge[c.p.id].useDataProxy || ($.isFunction(c.p.dataProxy) ? rp_ge[c.p.id].useDataProxy = !0 : (e[0] = !1, e[1] += " " + $.jgrid.getRegional(c, "errors.nourl"))), e[0])
												if (rp_ge[c.p.id].useDataProxy) {
													...
													"clientArray" === n.url ? (d = n.data, n.complete({
														status : 200,
														statusText : ""
													}, "")) : $.ajax(n)
										}
										...
										if (!$(this).hasClass(k.disabled)) {
											$.isFunction(m.beforeRefresh) && m.beforeRefresh.call(o), o.p.search = !1, o.p.resetsearch = !0;try {
												if ("currentfilter" !== m.refreshstate) {
													...
													} catch (a) {} $.isFunction(o.clearToolbar) && o.clearToolbar.call(o, !1)
												}
											} catch (a) {} switch (m.refreshstate) {
											case "firstpage":
			...
			_buildNavMenu : function(a, b, c, d, e, f, g, h) {
				return this.each(function() {
					...
					(function() {
						var a,
							j,
							k = $(".ui-jqgrid").css("font-size") || "11px",
								...
								$.isFunction(c.beforeRefresh) && c.beforeRefresh.call(i), i.p.search = !1, i.p.resetsearch = !0;try {
									if ("currentfilter" !== c.refreshstate) {
										...
										i.p.postData.filters = "";try {
											$("#fbox_" + $.jgrid.jqID(a)).jqFilter("resetFilter")
										} catch (a) {} $.isFunction(i.clearToolbar) && i.clearToolbar.call(i, !1)
									}
								} catch (a) {} switch (c.refreshstate) {
								case "firstpage":
				...
				return this.each(function() {
					...
					function f(a, c, d, f, g) {
						...
						for (i = f; i < b; i++) n[i].hidden ? k = "<td " + j.formatCol(i, 1, "") + ">&#160;</td>" : !q && g ? (k = g, q = !0) : k = "<td " + j.formatCol(i, 1, "") + ">&#160;</td>", $.each(m.summary, function() {
								if (this.nm === n[i].name) {
									l = n[i].summaryTpl ? n[i].summaryTpl : "{0}", "string" == typeof this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && o > 0 && (this.v = this.v / o));try {
					...
					if (g.grid) {
						...
						if ($.isFunction(b.beforeSetItem) && null != (c = b.beforeSetItem.call(g, e)) && (e = c), b.debug) {
							...
							var i,
								...
								k = [],
								l = {};
							k.push("Grid Options\n"), k.push(e), k.push("\n"), k.push("GridData\n"), k.push(f), l.type = "plain/text;charset=utf-8";try {
				...
				if (c = $.extend({
					...
					if (b) {
						...
						if ((d = $.jgrid.parseFunc(b)) && "object" === $.type(d)) {
							...
							d.shrinkToFit = !1, d.data = [], d.datatype = "local", d.grouping = !1, d.inlineNav && (g = j(d._iN), d._iN = null,
							delete d._iN
							), d.filterToolbar && (h = j(d._fT), d._fT = null,
							delete d._fT
							);
							var l = $("#" + a).jqGrid(d);
				...
				if (void 0 === x && (x = !0), x) {
					if (l = $(o).attr("editable"), i.url = i.url || j.p.editurl, "1" === l) {
						...
						if (D = !1 === j.p.keyName ? E.id : j.p.keyName, q) {
							if (q[E.oper] = E.editoper, void 0 === q[D] || "" === q[D])
								q[D] = a;
							else if (o.id !== j.p.idPrefix + q[D]) {
								var G = $.jgrid.stripPref(j.p.idPrefix, a);
								if (void 0 !== j.p._index[G] && (j.p._index[q[D]] = j.p._index[G],
									delete j.p._index[G]
									), a = j.p.idPrefix + q[D], $(o).attr("id", a), j.p.selrow === F && (j.p.selrow = a), $.isArray(j.p.selarrrow)) {
							...
							if (void 0 === h && (h = !0), h) {
								...
								if (f >= 0) {
									if ($.isFunction($.fn.datepicker)) try {
										...
										} catch (a) {} $.each(e.p.colModel, function() {
	...
	$.jgrid.extend({
		...
		pivotSetup : function(a, b) {
			...
			return this.each(function() {
					...
					function l(a, b, c, d, e) {
						var f;
						if ($.isFunction(a))
							f = a.call(w, b, c, d);else switch (a) {
							case "sum":
		...
		jqPivot : function(a, b, c, d) {
			return this.each(function() {
				function e(a) {
					$.isFunction(b.onInitPivot) && b.onInitPivot.call(f), $.isArray(a) || (a = []);var d,
						e,
						g,
						h,
					...
					if (h = b.xDimension.length, c.sortname) {
						for (e = c.sortorder ? c.sortorder : "asc", g = "text", d = 0; d < h; d++)
							if (b.xDimension[d].dataName === c.sortname) {
								g = b.xDimension[d].sorttype ? b.xDimension[d].sorttype : "text";break
						}
					...
					}, i.groupOptions, c || {}));var l = i.groupHeaders;
					if (l.length)
		...
		getNodeChildren : function(a, b) {
			...
			return this.each(function() {
					...
					if (d.grid && d.p.treeGrid) {
						var e,
							f,
							g = b ? this.rows.length : this.p.data.length;
			...
			return void 0 === b && (b = !1), this.each(function() {
					if (this.grid && this.p.treeGrid) {
						...
						for (var e = $(this).jqGrid("getNodeParent", a); e;) {
							if (c) try {
									e[c] = !0
								} catch (a) {} b ? d.unshift(e) : d.push(e), e = $(this).jqGrid("getNodeParent", e)
						}
					}
				}), d
		},
			...
			return this.each(function() {
					if (this.grid && this.p.treeGrid && h)
						for (b = this.p.localReader.id; h--;)
							if (i = $(this).jqGrid("getNodeAncestors", a[h], !0, !0), i.push(a[h]), c = i[0][b], -1 === $.inArray(c, j)) j.push(c), k = k.concat(i);else
			...
			return a.each(function() {
				b = b ? $(b, a) : a, b.on("mousedown", {
					...
					if (M = {
						...
						} catch (a) {} return $(document).mousemove($.jqDnR.drag).mouseup($.jqDnR.stop), !1
				})
			})
		},
		f = function(a) {
	...
	$.fmatter = {}, $.extend($.fmatter, {
		...
		if (void 0 !== b.colModel.formatoptions ? (e = b.colModel.formatoptions.value, c = void 0 === b.colModel.formatoptions.separator ? ":" : b.colModel.formatoptions.separator, d = void 0 === b.colModel.formatoptions.delimiter ? ";" : b.colModel.formatoptions.delimiter) : void 0 !== b.colModel.editoptions && (e = b.colModel.editoptions.value, c = void 0 === b.colModel.editoptions.separator ? ":" : b.colModel.editoptions.separator, d = void 0 === b.colModel.editoptions.delimiter ? ";" : b.colModel.editoptions.delimiter), e) {
			var g,
				h = !0 == (null != b.colModel.editoptions && !0 === b.colModel.editoptions.multiple),
				i = [];
	...
	$.fn.html5sortable = function(a) {
							...
							for (h = f; h < m; h++)
								if (l[h]._excol) {
									...
									$.each(j.summary, function() {
										if (this.nm === l[h].name) {
											l[h].summaryTpl && (p = l[h].summaryTpl), "string" == typeof this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && k > 0 && (this.v = this.v / k));try {
		...
		exportToExcel : function(a) {
			a = $.extend(!0, {
						...
						for (j = g; j < i; j++)
							if (l[j]._expcol) {
								...
								$.each(k.summary, function() {
									if (this.nm === l[j].name) {
										l[j].summaryTpl && (p = l[j].summaryTpl), "string" == typeof this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && m > 0 && (this.v = this.v / m));try {
				...
				var o,
					p,
					q = $.isFunction(a.replaceStr) ? a.replaceStr : b,
					r = function(b, c) {
				...
				$.isFunction(a.onBeforeExport) && a.onBeforeExport(k, h), n = null;try {
					var H = new JSZip,
						I = {
							type : "blob",
							mimeType : a.mimetype
		...
		exportToPdf : function(a) {
			return a = $.extend(!0, {
						...
						function d(a, b, d, f) {
							...
							for (i = f; i < r; i++)
								if (p[i]._expcol) {
									...
									$.each(j.summary, function() {
										if (this.nm === p[i].name) {
											p[i].summaryTpl && (n = p[i].summaryTpl), "string" == typeof this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && k > 0 && (this.v = this.v / k));try {
					...
					a.description && x.content.unshift({
						...
						style : "title",
						margin : [ 0, 0, 0, 12 ]
					}), $.isFunction(a.onBeforeExport) && a.onBeforeExport.call(g, x);try {
		...
		exportToHtml : function(a) {
			...
			return this.each(function() {
							...
							for (l = h; l < k; l++)
								if (g[l]._expcol) {
									...
									$.each(m.summary, function() {
										if (this.nm === g[l].name) {
											g[l].summaryTpl && (p = g[l].summaryTpl), "string" == typeof this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && n > 0 && (this.v = this.v / n));try {
					...
					if (a.includeFooter && f.p.footerrow && (i.footer = $(f).jqGrid("footerData", "get", null, !1), o += n(i.footer, "td", !1)), o += "</tbody>", o += "</table>", a.returnAsString)
						b = o;else {
						var q = window.open("", "");
						q.document.close();
