...
var DEFAULT_URL = '<%=request.getContextPath()%>/readerMacine/web/compressed.tracemonkey-pldi-09.pdf';
...
var DISABLE_AUTO_FETCH_LOADING_BAR_TIMEOUT = 5000;
  ...
  PDFJS.imageResourcesPath ='../../readerMacine/web/images/';
  PDFJS.workerSrc = '../../readerMacine/web/pdf.worker.js';
  PDFJS.cMapUrl = '../../readerMacine/web/cmaps/';
...
var PDFViewerApplication = {
  ...
  refreshThumbnailViewer: function pdfViewRefreshThumbnailViewer() {
    ...
    // set thumbnail 1 of rendered pages
