      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group has-feedback">
            <input type="text" name="jg_login_user" id="login_name" class="form-control" placeholder="登录名">
            <span class="glyphicon  glyphicon-user form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="text" name="jg_login_name" id="name" class="form-control" placeholder="用户姓名">
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
          ...
          <div class="form-group  text-center" id="wrap">
            <label class="radio-inline">
              <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="0" checked> 男
            </label>
            <label class="radio-inline">
              <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="1"> 女
            </label>
            <div class="InputAge">
            <input type="text" id="age" name="jg_login_age" placeholder="年龄">
          	</div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group has-feedback">
            <input type="text" name="jg_login_phone"  id="phone" class="form-control" placeholder="电话">
          ...
          <div class="form-group has-feedback">
            <input type="text" id="image" class="form-control" placeholder="头像">
