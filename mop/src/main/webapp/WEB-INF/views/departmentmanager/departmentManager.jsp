						...
						<div class="box box-primary">
							...
							<div class="box-body">
								<form class="form-horizontal" id="function-form">
									...
									<div class="form-group">
										<label for="name" class="col-sm-2 control-label">单位曾用名</label>
										<div class="col-sm-9">
									...
									<div class="form-group">
										<label for="name" class="col-sm-2 control-label">机构代码</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="depcode"
												name="depcode">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="contacts" class="col-sm-2 control-label">联系方式</label>
										<div class="col-sm-9">
									...
									<div class="form-group">
										<label for="contacts" class="col-sm-2 control-label">当前状态</label>
										<div class="col-sm-9">
											<select class="form-control" name="bolruin" id="bolruin">
									...
									<div class="form-group">
										<label for="introduce" class="col-sm-2 control-label">机构简介</label>
										<div class="col-sm-9">
...
　　			}; 
			...
			$(function() {
				...
				$('#function-form').bootstrapValidator({
					...
					if(confirm("确定提交么？")){
						...
						ajaxPost('<%=request.getContextPath()%>/rest/department/save', params, function(data, status) {
							if (data.success) {
				...
				$('button[data-btn-type]').click(function() {
					...
					case 'delete':
					    ...
					    if(confirm("确定提交么？")){
							ajaxPost("<%=request.getContextPath()%>/rest/department/delete/"+selectedNode.id,null,function(data){
					    		if(data.success){
					    		   modals.info('删除成功');
					    		}else{
			...
			function initTree(selectNodeId){
				var treeData = null;
				ajaxPost("<%=request.getContextPath()%>/rest/department/treeData", null, function(data) {
					 treeData = data;
					 console.log("===============");
					 console.log(data);
				});
			...
			function fillDictForm(node){
				form.clearForm();
				ajaxPost("<%=request.getContextPath()%>/rest/department/get/"+node.id,null,function(data){
