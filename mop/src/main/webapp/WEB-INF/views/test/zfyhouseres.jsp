...
<link rel="stylesheet" type="text/css" media="screen"
	href="<%=request.getContextPath()%>/AdminLTE/plugins/jqgrid/css/trirand/ui.jqgrid-bootstrap.css" />
<script>
...
<body>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$("#jqGrid").jqGrid({
				url : '<%=request.getContextPath()%>/rest/zfy/zfyfhouseresload',
				editurl : 'clientArray',
				datatype : "json",
				colModel : [
					{
			...
			$('#jqGrid').inlineNav('#jqGridPager',
				// the buttons to appear on the toolbar of the grid
				{
					...
					editParams : {
						...
						$.ajax({
							url:"<%=request.getContextPath()%>/rest/zfy/zfyfhouseresupdate",
							data:{jsdata:jsdata},
							dataType:"json",
							type:"POST",
							});
