            ...
            <form id="queryForm" action="" method="post">
                    <div class="col-sm-3">
			        	<select class="form-control" id="sle">
			        	   <option value="0"  hidden>工程状态</option>
    ...
    <table id="dataTable" class="table table-striped table-bordered table-hover table-condensed" align="center">
        ...
        <tr class="info">
           ...
           <!--  <th></th> -->
            ...
            <th width="5%" style="text-align:center">工程状态</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header" >
                    ...
                    <h4 class="modal-title" id="myModalLabel">工程状态信息：</h4>
                </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal"  id="editForm" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="inputName" class="col-sm-3 control-label">工程状态名称</label>
                            <div class="col-sm-9">
...
/* 确定按钮点击事件 */
    ...
    $(function () {
        ...
        var tables = $("#dataTable").dataTable({
            ...
            ajax: {
                type: "post",
                url: "<%=request.getContextPath()%>/rest/dic/dataProjectStatus",
                dataSrc: "data",
                dataType:'json',
                data: function(){
        ...
        $("#btn-submit").on("click", function () {
 				...
 				$.ajax({
 				url : "<%=request.getContextPath()%>/rest/dic/updateProjectStatus", 
 				type : 'post',
 				cache : "false",
 				data : params, //
 				dataType : "json",
        ...
        $("#dataTable tbody").on("click", "#delRow", function () {
            ...
            if (confirm("是否确认删除这条信息?")) {
                $.ajax({
                    url: "<%=request.getContextPath()%>/rest/dic/deleteProjectStatus",
                    type: 'post',
                    dataType: "json",
                    cache: "false",
                    data:data,
