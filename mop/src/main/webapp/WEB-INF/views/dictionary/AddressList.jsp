            ...
            <form id="queryForm" action="" method="post">
                    <div class="col-sm-3">
			        	<select class="form-control" id="sle">
			        	   <option value="0"  hidden>地点列表</option>
    ...
    <table id="dataTable" class="table table-striped table-bordered table-hover table-condensed" align="center">
        ...
        <tr class="info">
           ...
           <!--  <th></th> -->
            ...
            <th width="1%" style="text-align:center">城市ID</th>
            <th width="5%" style="text-align:center">城市名称</th>
            <th width="4%" style="text-align:center">城市上一级ID</th>
                ...
                <div class="modal-body">
                    <form class="form-horizontal"  id="editForm" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="inputName" class="col-sm-3 control-label">城市ID</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="cityid">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputName" class="col-sm-3 control-label">地点名称</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="cityname">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputName" class="col-sm-3 control-label">上一级城市ID</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="parentcityid">
                            </div>                     
                        </div>
...
/* 确定按钮点击事件 */
    ...
    $(function () {
        ...
        var tables = $("#dataTable").dataTable({
            ...
            ajax: {
                type: "post",
                url: "<%=request.getContextPath()%>/rest/dic/dataAddressList",
                dataSrc: "data",
                dataType:'json',
                data: function(){
        ...
        $("#btn-add").on("click", function () {
        	//初始化区域数据                         
           url = "<%=request.getContextPath()%>/rest/dic/updateAddressList";
           	$("input[name=id]").val("");
            $("input[name=cityid]").val("");
            $("input[name=cityname]").val("");
            $("input[name=parentcityid]").val("");
        ...
        $("#dataTable tbody").on("click", "#editRow", function () {
            ...
            $("input[name=parentcityid]").val(data.parentcityid);
            $("#editModal").modal("show");
        }); --%>
        ...
        $("#dataTable tbody").on("click", "#delRow", function () {
            ...
            if (confirm("是否确认删除这条信息?")) {
                $.ajax({
                    url: "<%=request.getContextPath()%>/rest/dic/deleteAddressList",
                    type: 'post',
                    dataType: "json",
                    cache: "false",
                    data:data,
