            ...
            <form id="queryForm" action="" method="post">
                    <div class="col-sm-3">
			        	<select class="form-control" id="sle">
			        	   <option value="0"  hidden>设备系统类型</option>
    ...
    <table id="dataTable" class="table table-striped table-bordered table-hover table-condensed" align="center">
        ...
        <tr class="info">
           ...
           <!--  <th></th> -->
            ...
            <th width="5%" style="text-align:center">设备系统类型</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header" >
                    ...
                    <h4 class="modal-title" id="myModalLabel">设备系统类型</h4>
                </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal"  id="editForm" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="inputName" class="col-sm-3 control-label">设备系统类型名称</label>
                            <div class="col-sm-9">
...
/* 确定按钮点击事件 */
    ...
    $(function () {
        ...
        var tables = $("#dataTable").dataTable({
            ...
            ajax: {
                type: "post",
                url: "<%=request.getContextPath()%>/rest/dic/datadevsystemType",
                dataSrc: "data",
                dataType:'json',
                data: function(){
        ...
        $("#btn-submit").on("click", function () {
 				...
 				$.ajax({
 				url : "<%=request.getContextPath()%>/rest/dic/updatedevsystemType", 
 				type : 'post',
 				cache : "false",
 				data : params, //
 				dataType : "json",
        ...
        $("#dataTable tbody").on("click", "#delRow", function () {
            ...
            if (confirm("是否确认删除这条信息?")) {
                $.ajax({
                    url: "<%=request.getContextPath()%>/rest/dic/deletedevsystemType",
                    type: 'post',
                    dataType: "json",
                    cache: "false",
                    data:data,
