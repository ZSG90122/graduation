			...
			<div class="row">
				<form id="queryForm" action="" method="post">
					...
					<div class="col-sm-1" style="width: 130px">
						<select class="form-control select2" id="queryleveltypeid"
							name="leveltype">
					...
					<div class="col-sm-1" style="width: 130px">
						<select class="form-control select2" id="queryfuntypeid"
							name="funtype">
							<option value="-1">全部</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="code"
												id="codeid" placeholder="填入遥控站的编号">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="address"
												id="addressid" placeholder="填入遥控站的地理位置">
										</div>
									</div>
									<div class="form-group">
										<label for="inputName" class="col-sm-2 control-label">管理科室</label>
										<div class="col-sm-4">
											<input type="hidden" class="form-control" name="depid"
												id='depidid'> <input type="text"
												class="form-control" name="depidname" id="depidnameid"
												placeholder="点击选择" onclick="ShowDepart()">
										</div>
							...
							<div class="panel panel-default" id="panel2">
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="radio-inline"> <input type="radio"
												name="leveltype" id="leveltypeid0" value="0" checked>
												A级站
											</label> <label class="radio-inline"> <input type="radio"
												name="leveltype" id="leveltypeid1" value="1"> B级站
											</label> <label class="radio-inline"> <input type="radio"
												name="leveltype" id="leveltypeid2" value="2"> C级站
											</label> <label class=radio-inline> <input type="radio"
												name="leveltype" id="leveltypeid3" value="3"> D级站
											</label> <label class="radio-inline"> <input type="radio"
												name="leveltype" id="leveltypeid4" value="4"> 小型站
											</label>
										</div>
									</div>
									...
									<div class="form-group" style="margin-bottom:-15px;">
										...
										<div class="col-sm-10">
											<label class="radio-inline"> <input type="radio"
												name="funtype" id="funtypeid0" value="0" checked>
												综合站
											</label> <label class="radio-inline"> <input type="radio"
												name="funtype" id="funtypeid1" value="1"> C波段
											</label> <label class="radio-inline"> <input type="radio"
												name="funtype" id="funtypeid2" value="2"> 短波站
											</label> <label class="radio-inline"> <input type="radio"
												name="funtype" id="funtypeid3" value="3"> 铁路监测
											</label> <label class="radio-inline"> <input type="radio"
												name="funtype" id="funtypeid4" value="4"> 航空监测
											</label>
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<label class="checkbox-inline"> <input
												type="checkbox" name="funtionlist" id="leveltypeid0"
												value="0" checked> 测量
											</label> <label class="checkbox-inline"> <input
												type="checkbox" name="funtionlist" id="leveltypeid1"
												value="1" checked> 测向
											</label> <label class="checkbox-inline"> <input
												type="checkbox" name="funtionlist" id="leveltypeid2"
												value="2" checked> 防雷
											</label> <label class="checkbox-inline"> <input
												type="checkbox" name="funtionlist" id="leveltypeid3"
												value="3" checked> 环控
											</label> <label class="checkbox-inline"> <input
												type="checkbox" name="funtionlist" id="leveltypeid4"
												value="4" checked> 短波监测
											</label>
										</div>
									</div>
								</div>
							...
							<div class="panel panel-default" id="panel4">
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="lat" id="latid"
												placeholder="">
										</div>
									</div>
									<div class="form-group" style="margin-bottom:-15px;">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="mainprotocal"
												id="mainprotocalid" placeholder="RMTP1.01或原子服务等">
										</div>
										<label for="inputName" class="col-sm-2 control-label">主IP</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" name="mainip"
												id="mainipid" placeholder="000.000.000.000">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="panel panel-default" id="panel4">
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="revalue"
												id="revalueid" placeholder="整个系统的采购价格">
										</div>
									</div>
									<div class="form-group" style="margin-bottom:-15px;">
										<label for="inputName" class="col-sm-2 control-label">供应商</label>
										<div class="col-sm-4">
											<select class="form-control select2" name="supdep"
												id="supdepid">
										...
										<div class="col-sm-4">
											<select class="form-control select2" name="condep"
												id="condepid">
												<option value="1">华日</option>
												<option value="2">中星</option>
											</select>
...
<script>
	...
	var form = null;
	var querydata=[];
	//这个querystr是来自controller中的
	//当填充表格的内容的时候这个变量会得到回调
...
//            },
               /*  data: function(){
                ...
                //data是传输给服务器的数据，可以添加我们自己的查询参数
                //这个querydata中还包括了许多的默认参数，如draw，length，start等
                data:querydata  //似乎querydata必须是对象，draw等参数才会被带过去
            },
            columns: [//对应上面thead里面的序列
            //data可以是属性名，或者嵌套属性、数组
                {"data": "null"},
			...
			//与columns类似，columns可以定义的属性在这里都可以定义
			//增加的targets属性用于指定列范围，columns的优先级高于这个
            columnDefs: [
                {
                //指定第一列为复选框
                    targets: 0,
