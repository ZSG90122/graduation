...
<div class="content">
	...
	<form class="form-horizontal"  id="form_update" action="" method="post">
	...
	<div class="row">
		<div class="col-md-3" style="margin:30px 0px 0px 350px;">
			<div class="form-group">
...
<script>
	...
	function initdepprojectbaseinfor(seldata){
        ...
        $("#btn-update-submit").on("click", function () {
 				...
 				console.log(params.id+"SSSSSSSSSSSSSSSS");
 				$.ajax({
 				url : "<%=request.getContextPath()%>/rest/datamanager/UpdateWord/"+Id, 
 				type : 'post',
 				cache : "false",
 				data : params, //
 				dataType : "json",
