...
(function(w) {
    ...
    var heatmapFactory = (function() {
        ...
        // public functions  prototyp(给类的对象添加方法的方法)
        heatmap.prototype = {
...
})(window);//把windows传入这个匿名函数中并且同时执行这个函数，在页面载入之前就执行；
...
(function() {
    ...
    HeatmapOverlay.prototype.initialize = function(map) {
        ...
        map.getPanes().mapPane.appendChild(el);//将新建的div添加到界面中去
    ...
    HeatmapOverlay.prototype.draw = function() {
        ...
        // this.conf.element.style.left = 0 + 'px';
        // this.conf.element.style.top = 0 + 'px';
        // this.conf.element.style.width = 0 + 'px';
        // this.conf.element.style.height = 0 + 'px';
