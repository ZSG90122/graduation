...
public class Btask implements Serializable {
	...
	public String toString() {
		return "Btask [id=" + id + ", type=" + type + ", taskcontent=" + taskcontent + ", state=" + state
				+ ", transperson=" + transperson + ", transtime=" + transtime + ", fillperson=" + fillperson
				+ ", filltime=" + filltime + ", finishcontent=" + finishcontent + ", remark=" + remark + "]";
	}
